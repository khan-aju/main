                                ...
                                <div class="card-body p-4 p-lg-5">
                                    ...
                                    <form action="" method="Post">
                                        ...
                                        <div class="d-flex align-items-center mb-3 pb-1">
                                            ...
                                            <span class="h1 fw-bold mb-0">Login For New Article</span>
                                        </div>

                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Sign in for adding
                                            new Article</h5>
                                        ...
                                        <p class="mb-5 pb-lg-2">Don't have an account? <a href="includes/register.php">Register here</a>
                                        </p>
